      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
            ...
            <Link className="text-xl font-semibold " to={"/studentProfile"}> Student Profile </Link>
            <Link className="text-xl font-semibold" to={"/myClass"}> My Class </Link>
            <Link className="text-xl font-semibold" to={"/online"}> Online </Link>
          </ul>
        </div>
      </div>
    </div>
